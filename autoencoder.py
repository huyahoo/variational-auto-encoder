...
class BaseModel():
    def __init__(self, args):
        ...
        self.test_loader = DataLoader(self.test_dataset, batch_size=5, shuffle=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', type=str, required=True, 
                        help='Mode to run the AutoEncoder. Options: "train", "evaluate", "sampling", "interpolate"')
    ...
    if mode == 'train':
        ...
        print(f'Invalid mode: {mode}. Options are "train", "evaluate", "sampling", "interpolate".')